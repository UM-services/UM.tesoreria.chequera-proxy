# Este script automatiza la generación y actualización de la wiki para el backend de chequeras de UM Tesoreria.
# El backend provee datos para que los usuarios consulten el estado de las chequeras de diferentes alumnos.
import os
import json
import subprocess
